...
1. Copy `local.properties.example` → `local.properties` at this directory (`apps/android/`).
2. Fill `sdk.dir`, `supabase.url`, and `supabase.anon.key` (same anon key as the web app).
